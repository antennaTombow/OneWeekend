...
void cornell_smoke() {
    ...
    world.add(make_shared<constant_medium>(box1, .01, color(0, 0, 0)));
    world.add(make_shared<constant_medium>(box2, .01, color(1, 1, 1)));
...
void final_scene(int image_width, int samples_per_pixel, int max_depth) {
    ...
    auto sphere_material = make_shared<lambertian>(color(.7, .3, .1));
    world.add(make_shared<sphere>(center1, center2, 50, sphere_material));

    world.add(make_shared<sphere>(point3(260, 150, 45), 50, make_shared<dielectric>(1.5)));
    world.add(make_shared<sphere>(
        point3(0, 150, 145), 50, make_shared<metal>(color(.8, .8, .9), 1.0)
    ));

    auto boundary = make_shared<sphere>(point3(360, 150, 145), 70, make_shared<dielectric>(1.5));
    world.add(boundary);
    world.add(make_shared<constant_medium>(boundary, .2, color(.2, .4, .9)));
