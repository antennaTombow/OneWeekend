...
public:
	...
	double focus_dist = 10;		// Distance from camera lookfrom point to focus plane
...
private:
	int image_height;		// Rendered iamge height
	...
	void initialize() {
		...
		// Calculate the location of the upper left pixel (P0,0)
	...
	color ray_color(const ray& r, int depth, const hittable& world) const {
		...
		// If we've exceedd the ray bounce limit, no more light is gathered.
		if (depth <= 0) {
			return color(0, 0, 0);
		}
