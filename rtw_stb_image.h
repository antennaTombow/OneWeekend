...
// Disable strict warnings for this header from MS Visual C++ compiler.
#ifdef _MSC_VER
...
public:
	...
	rtw_image(const char* image_filename) {
		...
		// images/ subdirectory, then the _parent's images/ subdirectory, and then _that_
		// parent, and so on, for six levels up. If the image was not loaded successfully,
		// width() and heigh() will return 0.
